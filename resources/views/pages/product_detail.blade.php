            ...
            <div class="container">
                <div class="content">
                    <ul class="breadcrumbs-page">
                        ...
                        <li><a href="shop-default.html" class="h6 link">Shop</a></li>
                        <li class="d-flex"><i class="icon icon-caret-right"></i></li>
                        <li>
                            <h6 class="current-page fw-normal">Casual Round Neck T-Shirt</h6>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="product-thumbs-slider">
                                    <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical"
                                        ...
                                        <div class="swiper-wrapper stagger-wrap">
                                            ...
                                            <div class="swiper-slide stagger-item" data-size="S" data-color="blue">
                                                <div class="item">
                                            ...
                                            <div class="swiper-slide stagger-item" data-size="M" data-color="blue">
                                                <div class="item">
                                            ...
                                            <div class="swiper-slide stagger-item" data-size="L" data-color="blue">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/fashion/product-4.jpg"
                                                        src="images/products/fashion/product-4.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-size="L" data-color="blue">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/fashion/product-5.jpg"
                                                        src="images/products/fashion/product-5.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-size="M" data-color="gray">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/fashion/product-6.jpg"
                                                        src="images/products/fashion/product-6.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-size="M" data-color="pink">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/fashion/product-7.jpg"
                                                        src="images/products/fashion/product-7.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-size="M" data-color="green">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/fashion/product-8.jpg"
                                                        src="images/products/fashion/product-8.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-size="M" data-color="gray">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/fashion/product-9.jpg"
                                                        src="images/products/fashion/product-9.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-size="M" data-color="gray">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/fashion/product-10.jpg"
                                                        src="images/products/fashion/product-10.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item" data-size="M" data-color="white">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/fashion/product-11.jpg"
                                                        src="images/products/fashion/product-11.jpg" alt="img-product">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide" data-size="XS" data-color="blue">
                                                    <a href="images/products/fashion/product-1.jpg" target="_blank" class="item"
                                                        data-pswp-width="860px" data-pswp-height="1146px">
                                                        <img class="tf-image-zoom lazyload" data-zoom="images/products/fashion/product-1.jpg"
                                                            data-src="images/products/fashion/product-1.jpg"
                                                            src="images/products/fashion/product-1.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide" data-size="S" data-color="blue">
                                                    <a href="images/products/fashion/product-2.jpg" target="_blank" class="item"
                                                        data-pswp-width="860px" data-pswp-height="1146px">
                                                        <img class="tf-image-zoom lazyload" data-zoom="images/products/fashion/product-2.jpg"
                                                            data-src="images/products/fashion/product-2.jpg"
                                                            src="images/products/fashion/product-2.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide" data-size="M" data-color="blue">
                                                    <a href="images/products/fashion/product-3.jpg" target="_blank" class="item"
                                                        data-pswp-width="860px" data-pswp-height="1146px">
                                                        <img class="tf-image-zoom lazyload" data-zoom="images/products/fashion/product-3.jpg"
                                                            data-src="images/products/fashion/product-3.jpg"
                                                            src="images/products/fashion/product-3.jpg" alt="img-product">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide" data-size="L" data-color="blue">
                                                    <a href="images/products/fashion/product-4.jpg" target="_blank" class="item"
                                                        data-pswp-width="860px" data-pswp-height="1146px">
                                                        <img class="tf-image-zoom lazyload" data-zoom="images/products/fashion/product-4.jpg"
                                                            data-src="images/products/fashion/product-4.jpg"
                                                            src="images/products/fashion/product-4.jpg" alt="img-product">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide" data-size="L" data-color="blue">
                                                    <a href="images/products/fashion/product-5.jpg" target="_blank" class="item"
                                                        data-pswp-width="860px" data-pswp-height="1146px">
                                                        <img class="tf-image-zoom lazyload" data-zoom="images/products/fashion/product-5.jpg"
                                                            data-src="images/products/fashion/product-5.jpg"
                                                            src="images/products/fashion/product-5.jpg" alt="img-product">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide" data-size="M" data-color="gray">
                                                    <a href="images/products/fashion/product-6.jpg" target="_blank" class="item"
                                                        data-pswp-width="860px" data-pswp-height="1146px">
                                                        <img class="tf-image-zoom lazyload" data-zoom="images/products/fashion/product-6.jpg"
                                                            data-src="images/products/fashion/product-6.jpg"
                                                            src="images/products/fashion/product-6.jpg" alt="img-product">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide" data-size="M" data-color="pink">
                                                    <a href="images/products/fashion/product-7.jpg" target="_blank" class="item"
                                                        data-pswp-width="860px" data-pswp-height="1146px">
                                                        <img class="tf-image-zoom lazyload" data-zoom="images/products/fashion/product-7.jpg"
                                                            data-src="images/products/fashion/product-7.jpg"
                                                            src="images/products/fashion/product-7.jpg" alt="img-product">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide" data-size="M" data-color="green">
                                                    <a href="images/products/fashion/product-8.jpg" target="_blank" class="item"
                                                        data-pswp-width="860px" data-pswp-height="1146px">
                                                        <img class="tf-image-zoom lazyload" data-zoom="images/products/fashion/product-8.jpg"
                                                            data-src="images/products/fashion/product-8.jpg"
                                                            src="images/products/fashion/product-8.jpg" alt="img-product">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide" data-size="M" data-color="gray">
                                                    <a href="images/products/fashion/product-9.jpg" target="_blank" class="item"
                                                        data-pswp-width="860px" data-pswp-height="1146px">
                                                        <img class="tf-image-zoom lazyload" data-zoom="images/products/fashion/product-9.jpg"
                                                            data-src="images/products/fashion/product-9.jpg"
                                                            src="images/products/fashion/product-9.jpg" alt="img-product">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide" data-size="M" data-color="gray">
                                                    <a href="images/products/fashion/product-10.jpg" target="_blank" class="item"
                                                        data-pswp-width="860px" data-pswp-height="1146px">
                                                        <img class="tf-image-zoom lazyload" data-zoom="images/products/fashion/product-10.jpg"
                                                            data-src="images/products/fashion/product-10.jpg"
                                                            src="images/products/fashion/product-10.jpg" alt="img-product">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide" data-size="M" data-color="white">
                                                    <a href="images/products/fashion/product-11.jpg" target="_blank" class="item"
                                                        data-pswp-width="860px" data-pswp-height="1146px">
                                                        <img class="tf-image-zoom lazyload" data-zoom="images/products/fashion/product-11.jpg"
                        ...
                        <div class="col-md-6">
                            <div class="tf-product-info-wrap position-relative">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    <h2 class="product-info-name">Casual Round Neck T-Shirt</h2>
                                    ...
                                    <div class="tf-product-heading">
                                        <div class="product-info-price price-wrap">
                                            <span class="price-new price-on-sale h2 fw-4">$ 14.99</span>
                                    ...
                                    <div class="tf-product-info-liveview">
                                        <div class="liveview-count">
                                            ...
                                            <span class="count fw-6 h6">23</span>
                                        </div>
                                    ...
                                    <div class="tf-product-trust-seal">
                                        ...
                                        <ul class="list-card">
                                            ...
                                            <li class="card-item">
                                                <img src="images/payment/master-card.png" alt="card">
                                            </li>
                                            <li class="card-item">
                                                <img src="images/payment/amex.png" alt="card">
                                            </li>
                                            <li class="card-item">
                                                <img src="images/payment/discover.png" alt="card">
                                            </li>
                                            <li class="card-item">
                        ...
                        <div class="tf-sticky-atc-product d-flex align-items-center">
                            <div class="tf-mini-cart-item align-items-start">
                                <div class="tf-mini-cart-image">
                                    <img class="lazyload" data-src="images/products/fashion/thumbs/thumbs-1.jpg"
                                        src="images/products/fashion/thumbs/thumbs-1.jpg" alt="img-product">
                                </div>
        ...
        <section>
            <div class="container">
                ...
                <div class="grid-photo tf-grid-layout tf-col-2 xl-col-4">
                    ...
                    <div class="wg-real-image">
                        <div class="image">
                            <img class="lazyload" src="images/products/product-5.jpg" data-src="images/products/product-5.jpg" alt="Photo">
                        </div>
                        <div class="box-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="wg-real-image">
                        <div class="image">
                            <img class="lazyload" src="images/products/product-7.jpg" data-src="images/products/product-7.jpg" alt="Photo">
                        </div>
                        <div class="box-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="wg-real-image">
                        <div class="image">
                            <img class="lazyload" src="images/products/product-9.jpg" data-src="images/products/product-9.jpg" alt="Photo">
                        </div>
                        <div class="box-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <div class="flat-animate-tab tab-style-1">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="tab-policy">
                                <div class="mb_32">
                                    ...
                                    <p class="h6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec a tortor commodo enim pulvinar
                                        hendrerit. Mauris a leo rutrum lectus vehicula dignissim feugiat eu felis. Fusce libero est, commodo vitae
                                        ultricies id, sollicitudin a augue. In finibus suscipit nulla, id bibendum diam fermentum sed.</p>
                                </div>
                                <div class="">
                                    ...
                                    <p class="h6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent bibendum arcu ut odio elementum,
                                        vel vestibulum lacus scelerisque. Integer egestas nisi eu nunc imperdiet.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane wd-product-descriptions" id="faqs" role="tabpanel">
                            <div class="tab-faqs">
                                <div class="flat-animate-tab tab-style-2">
                                    <ul class="menu-tab menu-tab-2" role="tablist">
                                        <li class="nav-tab-item" role="presentation">
                                            <a href="#Product" class="tab-link h5 active" data-bs-toggle="tab">Product details</a>
                                        </li>
                                        <li class="nav-tab-item" role="presentation">
                                            <a href="#Certification" class="tab-link h5" data-bs-toggle="tab">Certification & Hallmarking</a>
                                        </li>
                                        <li class="nav-tab-item" role="presentation">
                                            <a href="#Durability" class="tab-link h5" data-bs-toggle="tab">Durability & Safety</a>
                                        </li>
                                        <li class="nav-tab-item" role="presentation">
                                            <a href="#Shipping" class="tab-link h5" data-bs-toggle="tab">Shipping & Insurance</a>
                                        </li>
                                        <li class="nav-tab-item" role="presentation">
                                            <a href="#Payment" class="tab-link h5 " data-bs-toggle="tab">Payment methods</a>
                                        </li>
                                        <li class="nav-tab-item" role="presentation">
                                            <a href="#styling" class="tab-link h5" data-bs-toggle="tab">Product styling</a>
                                        </li>
                                        <li class="nav-tab-item" role="presentation">
                                            <a href="#Customization" class="tab-link h5" data-bs-toggle="tab">Customization & Repair</a>
                                        </li>
                                        <li class="nav-tab-item" role="presentation">
                                            <a href="#Jewellery" class="tab-link h5" data-bs-toggle="tab">Jewellery care</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content">
                                        <div class="tab-pane tab-faqs-descriptions active show" id="Product" role="tabpanel">
                                            <ul>
                                                <li>
                                                    <div class="h6 fw-6 text-black title">Type of diamond used?</div>
                                                    <div class="h6 fw-4 text">Natural diamonds with the highest ododj purity</div>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <div class="h6 fw-6 text-black title">What ring sizes are available?</div>
                                                    <div class="h6 fw-4 text">Sizes 5-26; Any size not available online can be customized.</div>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <div class="h6 fw-6 text-black title">Does the product cost include GST?</div>
                                                    <div class="h6 fw-4 text">Yes</div>
                                                </li>
                                                <li>
                                                    <div class="h6 fw-6 text-black title">What % of GST is applicable on the product?</div>
                                                    <div class="h6 fw-4 text">2%</div>
                                                </li>
                                                <li>
                                                    <div class="h6 fw-6 text-black title">Does the product cost include shipping?</div>
                                                    <div class="h6 fw-4 text">Yes</div>
                                                </li>
                                                <li>
                                                    <div class="h6 fw-6 text-black title">Does the product cost include product discounts?</div>
                                                    <div class="h6 fw-4 text">Yes. However, any applicable coupon can be applied at the time of
                                                        payment.</div>
                                                </li>
                                                <li>
                                                    <div class="h6 fw-6 text-black title">Are there any other hidden costs?</div>
                                                    <div class="h6 fw-4 text">No there are no hidden costs or additional charges.</div>
                                                </li>
                                                <li>
                                                    <div class="h6 fw-6 text-black title">Is there a price breakup available for the product price?
                                                    </div>
                                                    <div class="h6 fw-4 text">Yes, same is available in the price break-up section.</div>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="tab-pane tab-faqs-descriptions" id="Certification" role="tabpanel">
                                            <ul>
                                                <li>
                                                    <div class="h6 fw-6 text-black title">Type of diamond used?</div>
                                                    <div class="h6 fw-4 text">Natural diamonds with the highest ododj purity</div>
                                        ...
                                        <div class="tab-pane tab-faqs-descriptions" id="Durability" role="tabpanel">
                                            <ul>
                                                <li>
                                                    <div class="h6 fw-6 text-black title">Type of diamond used?</div>
                                                    <div class="h6 fw-4 text">Natural diamonds with the highest ododj purity</div>
                                        ...
                                        <div class="tab-pane tab-faqs-descriptions" id="Shipping" role="tabpanel">
                                            <ul>
                                                <li>
                                                    <div class="h6 fw-6 text-black title">Type of diamond used?</div>
                                                    <div class="h6 fw-4 text">Natural diamonds with the highest ododj purity</div>
                                        ...
                                        <div class="tab-pane tab-faqs-descriptions" id="Payment" role="tabpanel">
                                            <ul>
                                                <li>
                                                    <div class="h6 fw-6 text-black title">Type of diamond used?</div>
                                                    <div class="h6 fw-4 text">Natural diamonds with the highest ododj purity</div>
                                        ...
                                        <div class="tab-pane tab-faqs-descriptions" id="styling" role="tabpanel">
                                            <ul>
                                                <li>
                                                    <div class="h6 fw-6 text-black title">Type of diamond used?</div>
                                                    <div class="h6 fw-4 text">Natural diamonds with the highest ododj purity</div>
                                        ...
                                        <div class="tab-pane tab-faqs-descriptions" id="Customization" role="tabpanel">
                                            <ul>
                                                <li>
                                                    <div class="h6 fw-6 text-black title">Type of diamond used?</div>
                                                    <div class="h6 fw-4 text">Natural diamonds with the highest ododj purity</div>
                                        ...
                                        <div class="tab-pane tab-faqs-descriptions" id="Jewellery" role="tabpanel">
                                            <ul>
                                                <li>
                                                    <div class="h6 fw-6 text-black title">Type of diamond used?</div>
                                                    <div class="h6 fw-4 text">Natural diamonds with the highest ododj purity</div>
                                ...
                                <div class="card-product_info">
                                    ...
                                    <ul class="product-color_list d-none">
                                        <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                            ...
                                            <img class="lazyload" src="images/products/product-21.jpg" data-src="images/products/product-21.jpg"
                                                alt="Product">
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="card-product_info">
                                    ...
                                    <ul class="product-color_list">
                                        <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                            <span class="tooltip color-filter">Dark</span>
                                            <span class="swatch-value bg-dark-charcoal"></span>
                                            <img class="lazyload" src="images/products/product-33.jpg" data-src="images/products/product-33.jpg"
                                                alt="Product">
                                        </li>
                                        <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                            ...
                                            <img class="lazyload" src="images/products/product-35.jpg" data-src="images/products/product-35.jpg"
                                                alt="Product">
                                        ...
                                        <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                            ...
                                            <img class="lazyload" src="images/products/product-36.jpg" data-src="images/products/product-36.jpg"
                                                alt="Product">
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="card-product_info">
                                    ...
                                    <ul class="product-color_list">
                                        <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                            ...
                                            <img class="lazyload" src="images/products/product-37.jpg" data-src="images/products/product-37.jpg"
                                                alt="Product">
                                        </li>
                                        <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                            <span class="tooltip color-filter">Pink</span>
                                            <span class="swatch-value bg-hot-pink"></span>
                                            <img class="lazyload" src="images/products/product-39.jpg" data-src="images/products/product-39.jpg"
                                                alt="Product">
                                        ...
                                        <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                            <span class="tooltip color-filter">Beige</span>
                                            <span class="swatch-value bg-light-beige"></span>
                                            <img class="lazyload" src="images/products/product-40.jpg" data-src="images/products/product-40.jpg"
                                                alt="Product">
                                        </li>
                                    </ul>
                                </div>
