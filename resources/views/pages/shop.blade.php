<x-app>
      <!-- Page Title -->
        <section class="s-page-title">
            <div class="container">
                <div class="content">
                    <h1 class="title-page">Shop 2 Columns</h1>
            ...
            <div class="container">
                <div class="tf-shop-control">
                    ...
                    <ul class="tf-control-layout">
                        <li class="tf-view-layout-switch sw-layout-2 active" data-value-layout="tf-col-2">
                ...
                <div class="wrapper-control-shop gridLayout-wrapper">
                    ...
                    <div class="wrapper-shop tf-grid-layout tf-col-2" id="gridLayout">
                        ...
                        <div class="card-product grid" data-availability="In stock" data-brand="fisoew">
                            <div class="card-product_wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" src="images/products/product-23.jpg" data-src="images/products/product-23.jpg"
                                        alt="Product">
                                    <img class="lazyload img-hover" src="images/products/product-24.jpg" data-src="images/products/product-24.jpg"
                                        alt="Product">
                                </a>
                                <ul class="product-action_list">
                                    <li>
                        ...
                        <!-- Product 2 -->
                        <div class="card-product grid" data-availability="In stock" data-brand="zeagoo">
                            <div class="card-product_wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" src="images/products/product-27.jpg" data-src="images/products/product-27.jpg"
                                        alt="Product">
                                    <img class="lazyload img-hover" src="images/products/product-28.jpg" data-src="images/products/product-28.jpg"
                                        alt="Product">
                                </a>
                                <ul class="product-action_list">
                                    <li>
                            ...
                            <div class="card-product_info">
                                ...
                                <ul class="product-color_list">
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                        <span class="tooltip color-filter">Beige</span>
                                        <span class="swatch-value bg-light-beige"></span>
                                        <img class="lazyload" src="images/products/product-27.jpg" data-src="images/products/product-27.jpg"
                                            alt="Product">
                                    </li>
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                        <span class="tooltip color-filter">Violet</span>
                                        <span class="swatch-value bg-muted-violet"></span>
                                        <img class="lazyload" src="images/products/product-29.jpg" data-src="images/products/product-29.jpg"
                                            alt="Product">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <!-- Product 3 -->
                        <div class="card-product grid" data-availability="Out of stock" data-brand="shewin">
                            <div class="card-product_wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" src="images/products/product-30.jpg" data-src="images/products/product-30.jpg"
                                        alt="Product">
                                    <img class="lazyload img-hover" src="images/products/product-31.jpg" data-src="images/products/product-31.jpg"
                                        alt="Product">
                                </a>
                            ...
                            <div class="card-product_info">
                                ...
                                <ul class="product-color_list">
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                        <span class="tooltip color-filter">Beige</span>
                                        <span class="swatch-value bg-light-beige"></span>
                                        <img class="lazyload" src="images/products/product-30.jpg" data-src="images/products/product-30.jpg"
                                            alt="Product">
                                    </li>
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                        <span class="tooltip color-filter">Dark</span>
                                        <span class="swatch-value bg-dark-charcoal"></span>
                                        <img class="lazyload" src="images/products/product-32.jpg" data-src="images/products/product-32.jpg"
                                            alt="Product">
                        ...
                        <div class="card-product grid" data-availability="In stock" data-brand="automet">
                            <div class="card-product_wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" src="images/products/product-7.jpg" data-src="images/products/product-7.jpg"
                                        alt="Product">
                                    <img class="lazyload img-hover" src="images/products/product-8.jpg" data-src="images/products/product-8.jpg"
                                        alt="Product">
                                </a>
                                <ul class="product-action_list">
                                    <li>
                            ...
                            <div class="card-product_info">
                                <a href="product-detail.html" class="name-product h4 link">Summer Linen Pants</a>
                                <div class="price-wrap">
                                ...
                                <ul class="product-color_list">
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                        <span class="tooltip color-filter">Pink</span>
                                        <span class="swatch-value bg-hot-pink"></span>
                                        <img class="lazyload" src="images/products/product-7.jpg" data-src="images/products/product-7.jpg"
                                            alt="Product">
                                    </li>
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                        <span class="tooltip color-filter">Beige</span>
                                    ...
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                        ...
                                        <img class="lazyload" src="images/products/product-11.jpg" data-src="images/products/product-11.jpg"
                                            alt="Product">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <!-- Product 5 -->
                        <div class="card-product grid" data-availability="In stock" data-brand="dokotoo">
                            <div class="card-product_wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" src="images/products/product-21.jpg" data-src="images/products/product-21.jpg"
                                        alt="Product">
                        ...
                        <!-- Product 6 -->
                        <div class="card-product grid" data-availability="In stock" data-brand="blooming-jelly">
                            <div class="card-product_wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" src="images/products/product-33.jpg" data-src="images/products/product-33.jpg"
                                        alt="Product">
                        ...
                        <!-- Product 7 -->
                        <div class="card-product grid" data-availability="In stock" data-brand="trendy-queen">
                            <div class="card-product_wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" src="images/products/product-37.jpg" data-src="images/products/product-37.jpg"
                                        alt="Product">
                        ...
                        <!-- Product 8 -->
                        <div class="card-product grid" data-availability="In stock" data-brand="hanes">
                            <div class="card-product_wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" src="images/products/product-41.jpg" data-src="images/products/product-41.jpg"
                                        alt="Product">
                        ...
                        <!-- Product 9 -->
                        <div class="card-product grid" data-availability="Out of stock" data-brand="wiholl">
                            <div class="card-product_wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" src="images/products/product-45.jpg" data-src="images/products/product-45.jpg"
                                        alt="Product">
                            ...
                            <div class="card-product_info">
                                <a href="product-detail.html" class="name-product h4 link">Loose V-neck T-shirt</a>
                                <div class="price-wrap">
                        ...
                        <!-- Product 10 -->
                        <div class="card-product grid" data-availability="In stock" data-brand="real-essentials">
                            <div class="card-product_wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" src="images/products/product-49.jpg" data-src="images/products/product-49.jpg"
                                        alt="Product">
                                    <img class="lazyload img-hover" src="images/products/product-50.jpg" data-src="images/products/product-50.jpg"
                                        alt="Product">
                                </a>
                                <div class="variant-box">
                                    <ul class="product-size_list">
                            ...
                            <div class="card-product_info">
                                <a href="product-detail.html" class="name-product h4 link">Fashionable workout tops</a>
                                <div class="price-wrap">
                                    <span class="price-old h6 fw-normal">$119,99</span>
                                    <span class="price-new h6">$84,99</span>
                                </div>
                                <ul class="product-color_list">
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                        <span class="tooltip color-filter">Beige</span>
                                        <span class="swatch-value bg-light-beige"></span>
                                        <img class="lazyload" src="images/products/product-49.jpg" data-src="images/products/product-49.jpg"
                                            alt="Product">
                                    </li>
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                        <span class="tooltip color-filter">Dark</span>
                                        <span class="swatch-value bg-dark-charcoal"></span>
                                        <img class="lazyload" src="images/products/product-51.jpg" data-src="images/products/product-51.jpg"
                                            alt="Product">
                                    ...
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                        ...
                                        <img class="lazyload" src="images/products/product-52.jpg" data-src="images/products/product-52.jpg"
                                            alt="Product">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <!-- Product 11 -->
                        <div class="card-product grid" data-availability="In stock" data-brand="wiholl">
                            <div class="card-product_wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" src="images/products/product-53.jpg" data-src="images/products/product-53.jpg"
                                        alt="Product">
                                    <img class="lazyload img-hover" src="images/products/product-54.jpg" data-src="images/products/product-54.jpg"
                                        alt="Product">
                                </a>
                                <ul class="product-action_list">
                                    <li>
                            ...
                            <div class="card-product_info">
                                ...
                                <div class="price-wrap">
                                    ...
                                    <span class="price-new h6">$34,99</span>
                                </div>
                                <ul class="product-color_list">
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                        <span class="tooltip color-filter">Black</span>
                                        <span class="swatch-value bg-black"></span>
                                        <img class="lazyload" src="images/products/product-53.jpg" data-src="images/products/product-53.jpg"
                                            alt="Product">
                                    </li>
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                        <span class="tooltip color-filter">Beige</span>
                                        <span class="swatch-value bg-light-beige"></span>
                                        <img class="lazyload" src="images/products/product-55.jpg" data-src="images/products/product-55.jpg"
                                            alt="Product">
                                    ...
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                        <span class="tooltip color-filter">Dusty Olive</span>
                                        <span class="swatch-value bg-dusty-olive"></span>
                                        <img class="lazyload" src="images/products/product-56.jpg" data-src="images/products/product-56.jpg"
                                            alt="Product">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="card-product grid" data-availability="In stock" data-brand="dokotoo">
                            <div class="card-product_wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" src="images/products/product-57.jpg" data-src="images/products/product-57.jpg"
                                        alt="Product">
                                    <img class="lazyload img-hover" src="images/products/product-58.jpg" data-src="images/products/product-58.jpg"
                                        alt="Product">
                                </a>
                                <ul class="product-action_list">
                                    <li>
                            ...
                            <div class="card-product_info">
                                <a href="product-detail.html" class="name-product h4 link">Half zip pullover</a>
                                <div class="price-wrap">
                                    <span class="price-old h6 fw-normal">$109,99</span>
                                    <span class="price-new h6">$74,99</span>
                                </div>
                                <ul class="product-color_list">
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                        <span class="tooltip color-filter">White</span>
                                        <span class="swatch-value bg-white"></span>
                                        <img class="lazyload" src="images/products/product-57.jpg" data-src="images/products/product-57.jpg"
                                            alt="Product">
                                    </li>
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                        <span class="tooltip color-filter">Orange</span>
                                        <span class="swatch-value bg-honey-orange"></span>
                                        <img class="lazyload" src="images/products/product-59.jpg" data-src="images/products/product-59.jpg"
                                            alt="Product">
                                    ...
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                        <span class="tooltip color-filter">Violet</span>
                                        <span class="swatch-value bg-muted-violet"></span>
                                        <img class="lazyload" src="images/products/product-60.jpg" data-src="images/products/product-60.jpg"
                                            alt="Product">
                                    </li>
                                    <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                        <span class="tooltip color-filter">Purple</span>
                                        <span class="swatch-value bg-light-purple"></span>
                                        <img class="lazyload" src="images/products/product-61.jpg" data-src="images/products/product-61.jpg"
                                            alt="Product">
                                    </li>
                                </ul>
                            </div>
